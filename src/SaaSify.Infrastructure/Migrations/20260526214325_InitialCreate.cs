        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    api_key_hash = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    external_payment_ref = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    renews_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "uq_customers_project_id_external_id",
                table: "customers",
                columns: new[] { "project_id", "external_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "uq_features_plan_id_slug",
                table: "features",
                columns: new[] { "plan_id", "slug" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "uq_projects_api_key_prefix",
                table: "projects",
            ...
            migrationBuilder.CreateIndex(
                name: "uq_subscriptions_customer_active",
                table: "subscriptions",
                column: "customer_id",
                unique: true,
